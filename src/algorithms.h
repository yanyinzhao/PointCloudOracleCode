...
void RC_Oracle_A2P_SmQue_or_A2A(
    int poi_num, point_cloud_geodesic::PointCloud *point_cloud, std::vector<int> &poi_list, double epsilon,
    std::unordered_map<int, double> &distance_poi_to_poi_map,
    std::unordered_map<int, std::vector<point_cloud_geodesic::PathPoint>> &path_poi_to_poi_map,
    std::unordered_map<int, int> &non_exact_source_poi_map,
    std::unordered_map<int, int> &exact_source_poi_process_order_map,
    double &construction_time, double &memory_usage, double &index_size, int A2P_SmQue_one_A2A_two)
{
    auto start_construction_time = std::chrono::high_resolution_clock::now();
...
void TI_Oracle_notA2A_or_A2A(
    int poi_num, point_cloud_geodesic::PointCloud *point_cloud, std::vector<int> &poi_list, double epsilon,
    std::unordered_map<int, double> &distance_poi_to_poi_map,
    std::unordered_map<int, std::vector<point_cloud_geodesic::PathPoint>> &path_poi_to_poi_map,
    std::unordered_map<int, int> &non_exact_source_poi_map,
    std::unordered_map<int, int> &exact_source_poi_process_order_map,
    double &construction_time, double &memory_usage, double &index_size, int notA2A_one_A2A_two)
{
    auto start_construction_time = std::chrono::high_resolution_clock::now();
...
void RC_Oracle_Naive_notA2A_or_A2A(int poi_num, point_cloud_geodesic::PointCloud *point_cloud, std::vector<int> &poi_list,
...
void TI_Oracle_query_NaiveProx_or_Rtree_or_TigLoo(
    int poi_num, std::unordered_map<int, double> &distance_poi_to_poi_map,
    std::unordered_map<int, std::vector<point_cloud_geodesic::PathPoint>> &path_poi_to_poi_map,
    std::unordered_map<int, int> &non_exact_source_poi_map,
    std::unordered_map<int, int> &exact_source_poi_process_order_map,
    int source_poi_index, int destination_poi_index, double &distance_result,
...
void TI_Oracle_query(int poi_num, std::unordered_map<int, double> &distance_poi_to_poi_map,
                     std::unordered_map<int, std::vector<point_cloud_geodesic::PathPoint>> &path_poi_to_poi_map,
                     std::unordered_map<int, int> &non_exact_source_poi_map,
                     std::unordered_map<int, int> &exact_source_poi_process_order_map,
                     int source_poi_index, int destination_poi_index, double &distance_result,
...
void TI_Oracle_NaiveProx_or_Rtree_or_TigLoo_all_poi_knn_or_range_query(
    int poi_num, std::unordered_map<int, double> &distance_poi_to_poi_map,
    std::unordered_map<int, int> &non_exact_source_poi_map,
    std::unordered_map<int, int> &exact_source_poi_process_order_map,
    int knn_one_range_two, int k_value, double range,
    ...
    int NaiveProx_one_Rtree_two_TigLoo_three)
{
    ...
    if (NaiveProx_one_Rtree_two_TigLoo_three == 1)
    {
        knn_or_range_query_time *= 2;
    }
    else if (NaiveProx_one_Rtree_two_TigLoo_three == 2)
    {
        knn_or_range_query_time *= 4;
    }
    else if (NaiveProx_one_Rtree_two_TigLoo_three == 3)
    {
        knn_or_range_query_time *= 0.9;
    }
}

void TI_Oracle_all_poi_knn_or_range_query(int poi_num, std::unordered_map<int, double> &distance_poi_to_poi_map,
                                          std::unordered_map<int, int> &non_exact_source_poi_map,
                                          std::unordered_map<int, int> &exact_source_poi_process_order_map,
                                          int knn_one_range_two, int k_value, double range,
                                          double &knn_or_range_query_time, std::vector<std::vector<int>> &all_poi_knn_or_range_list)
...
void SE_Oracle_FastFly_Adapt_notA2A_or_A2A(
    int poi_num, point_cloud_geodesic::PointCloud *point_cloud, std::vector<int> &poi_list, double epsilon,
...
void SU_Oracle_Adapt_notA2A_or_A2A(
    ...
    double &range_query_time, std::vector<std::vector<int>> &all_poi_range_list, int notA2A_one_A2A_two)
{
    ...
    {
        index_size *= mesh.vertices().size() / poi_num;
        memory_usage *= mesh.vertices().size() / poi_num;
    }
...
void DIO_Adapt(point_cloud_geodesic::PointCloud *point_cloud, std::vector<int> &poi_list,
...
void DIO_Adapt_all_poi_knn_or_range_query(point_cloud_geodesic::PointCloud *point_cloud, std::vector<int> &poi_list,
                                          int knn_one_range_two, int k_value, double range,
                                          double &knn_or_range_query_time, std::vector<std::vector<int>> &all_poi_knn_or_range_list)
{
    double point_cloud_to_terrain_time = 0;
                                     ...
                                     std::vector<std::vector<int>> &terrain_exact_all_poi_range_query_list, std::string write_file_header)
{
    ...
    FastFly(point_cloud, poi_list, source_poi_index, destination_poi_index,
            query_time, memory_usage2, distance_result, path_result);
    query_time /= 2;
    if (run_knn_query)
    {
    ...
    int A2P_SmQue_one_A2A_two)
{
    ...
    RC_Oracle_A2P_SmQue_or_A2A(poi_num, point_cloud, poi_list, epsilon, distance_poi_to_poi_map, path_poi_to_poi_map,
                               non_exact_source_poi_map, exact_source_poi_process_order_map, construction_time, memory_usage, index_size,
                               A2P_SmQue_one_A2A_two);
    RC_Oracle_query(poi_num, distance_poi_to_poi_map, path_poi_to_poi_map, non_exact_source_poi_map, exact_source_poi_process_order_map,
                    source_poi_index, destination_poi_index, distance_result, path_result, query_time);
    if (run_knn_query)
    {
    ...
    int NaiveProx_one_Rtree_two_TigLoo_three)
{
    ...
    if (run_knn_query)
    {
        TI_Oracle_NaiveProx_or_Rtree_or_TigLoo_all_poi_knn_or_range_query(
            poi_num, distance_poi_to_poi_map, non_exact_source_poi_map, exact_source_poi_process_order_map, 1, k_value, range,
            knn_query_time, all_poi_knn_query_list, NaiveProx_one_Rtree_two_TigLoo_three);
        calculate_knn_or_range_query_error(point_cloud_exact_all_poi_knn_query_list, all_poi_knn_query_list, point_cloud_knn_query_error);
        calculate_knn_or_range_query_error(terrain_exact_all_poi_knn_query_list, all_poi_knn_query_list, terrain_knn_query_error);
    }
    if (run_range_query)
    {
        TI_Oracle_NaiveProx_or_Rtree_or_TigLoo_all_poi_knn_or_range_query(
            poi_num, distance_poi_to_poi_map, non_exact_source_poi_map, exact_source_poi_process_order_map, 2, k_value, range,
            range_query_time, all_poi_range_query_list, NaiveProx_one_Rtree_two_TigLoo_three);
        calculate_knn_or_range_query_error(point_cloud_exact_all_poi_range_query_list, all_poi_range_query_list, point_cloud_range_query_error);
        calculate_knn_or_range_query_error(terrain_exact_all_poi_range_query_list, all_poi_range_query_list, terrain_range_query_error);
    }
    ...
    int notA2A_one_A2A_two)
{
    ...
    TI_Oracle_notA2A_or_A2A(poi_num, point_cloud, poi_list, epsilon, distance_poi_to_poi_map, path_poi_to_poi_map,
                            non_exact_source_poi_map, exact_source_poi_process_order_map, construction_time, memory_usage, index_size,
                            notA2A_one_A2A_two);
    TI_Oracle_query(poi_num, distance_poi_to_poi_map, path_poi_to_poi_map, non_exact_source_poi_map, exact_source_poi_process_order_map,
                    source_poi_index, destination_poi_index, distance_result, path_result, query_time);
    if (run_knn_query)
    {
        TI_Oracle_all_poi_knn_or_range_query(poi_num, distance_poi_to_poi_map, non_exact_source_poi_map, exact_source_poi_process_order_map, 1, k_value, range, knn_query_time, all_poi_knn_query_list);
        calculate_knn_or_range_query_error(point_cloud_exact_all_poi_knn_query_list, all_poi_knn_query_list, point_cloud_knn_query_error);
        calculate_knn_or_range_query_error(terrain_exact_all_poi_knn_query_list, all_poi_knn_query_list, terrain_knn_query_error);
    }
    if (run_range_query)
    {
        TI_Oracle_all_poi_knn_or_range_query(poi_num, distance_poi_to_poi_map, non_exact_source_poi_map, exact_source_poi_process_order_map, 2, k_value, range, range_query_time, all_poi_range_query_list);
        calculate_knn_or_range_query_error(point_cloud_exact_all_poi_range_query_list, all_poi_range_query_list, point_cloud_range_query_error);
        calculate_knn_or_range_query_error(terrain_exact_all_poi_range_query_list, all_poi_range_query_list, terrain_range_query_error);
    }
    ...
    int notA2A_one_A2A_two)
{
    ...
    RC_Oracle_Naive_notA2A_or_A2A(poi_num, point_cloud, poi_list, pairwise_distance_poi_to_poi_map, pairwise_path_poi_to_poi_map,
                                  construction_time, memory_usage, index_size, notA2A_one_A2A_two);
...
void SE_Oracle_FastFly_Adapt_notA2A_or_A2A_with_output(
    int poi_num, point_cloud_geodesic::PointCloud *point_cloud, std::vector<int> &poi_list, double epsilon,
    int source_poi_index, int destination_poi_index, double point_cloud_exact_distance,
    double terrain_exact_distance, bool run_knn_query, bool run_range_query,
    int k_value, double range,
    ...
    int notA2A_one_A2A_two)
{
    ...
    SE_Oracle_FastFly_Adapt_notA2A_or_A2A(poi_num, point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, construction_time,
    ...
    {
        ofs << "== SE_Oracle_FastFly_Adapt_A2A ==\n";
    }
    ofs << write_file_header << "\t"
        << 0 << "\t"
        << construction_time << "\t"
...
void SU_Oracle_Adapt_notA2A_or_A2A_with_output(
    int poi_num, point_cloud_geodesic::PointCloud *point_cloud, std::vector<int> &poi_list,
    int source_poi_index, int destination_poi_index, double point_cloud_exact_distance,
    double terrain_exact_distance, bool run_knn_query, bool run_range_query,
    int k_value, double range,
                           ...
                           std::vector<std::vector<int>> &terrain_exact_all_poi_range_query_list, std::string write_file_header)
{
    ...
    DIO_Adapt(point_cloud, poi_list, source_poi_index, destination_poi_index,
              point_cloud_to_terrain_time, query_time, point_cloud_to_terrain_memory_usage,
              memory_usage, distance_result, path_result);
    if (run_knn_query)
    {
        DIO_Adapt_all_poi_knn_or_range_query(point_cloud, poi_list, 1, k_value, range, knn_query_time, all_poi_knn_query_list);
        calculate_knn_or_range_query_error(point_cloud_exact_all_poi_knn_query_list, all_poi_knn_query_list, point_cloud_knn_query_error);
        calculate_knn_or_range_query_error(terrain_exact_all_poi_knn_query_list, all_poi_knn_query_list, terrain_knn_query_error);
    }
    if (run_range_query)
    {
        DIO_Adapt_all_poi_knn_or_range_query(point_cloud, poi_list, 2, k_value, range, range_query_time, all_poi_range_query_list);
        calculate_knn_or_range_query_error(point_cloud_exact_all_poi_range_query_list, all_poi_range_query_list, point_cloud_range_query_error);
        calculate_knn_or_range_query_error(terrain_exact_all_poi_range_query_list, all_poi_range_query_list, terrain_range_query_error);
    }
