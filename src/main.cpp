...
int main(int argc, char **argv)
{
    ...
    std::cout << "dataset: " << input_file[input_file_index].point_cloud_or_terrain << "\tpoint_num: " << point_cloud.pc_points().size() << "\tpoi_num: " << poi_num << "\tepsilon: " << epsilon << std::endl;
    std::cout << std::endl;
    ...
    if (input_file_index >= 0 && input_file_index <= 29)
    {
        ...
        SE_Oracle_or_SE_Oracle_Adapt_notA2A_AR2AR_or_A2A_AR2AR_with_output(
            poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        ...
        SE_Oracle_or_SE_Oracle_Adapt_notA2A_AR2AR_or_A2A_AR2AR_with_output(
            ...
            terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
            terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
            write_file_header, 1, 2);
        std::cout << std::endl;

        std::cout << "== SE_Oracle_AR2AR ==" << std::endl;
        SE_Oracle_or_SE_Oracle_Adapt_notA2A_AR2AR_or_A2A_AR2AR_with_output(
            poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
            terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
            terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
            write_file_header, 2, 2);
        std::cout << std::endl;

        std::cout << "== UP_Oracle_Adapt ==" << std::endl;
        UP_Oracle_or_UP_Oracle_Adapt_notA2A_AR2AR_or_A2A_AR2AR_with_output(
            poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
            terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
            terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
            write_file_header, 1, 1);
        ...
        std::cout << "== UP_Oracle_Adapt_A2A ==" << std::endl;
        UP_Oracle_or_UP_Oracle_Adapt_notA2A_AR2AR_or_A2A_AR2AR_with_output(
            poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
            terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
            terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
        ...
        std::cout << "== UP_Oracle_AR2AR ==" << std::endl;
        UP_Oracle_or_UP_Oracle_Adapt_notA2A_AR2AR_or_A2A_AR2AR_with_output(
            poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
            terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
            terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
        ...
        EAR_Oracle_or_EAR_Oracle_Adapt_with_output(poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
                                                   terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
                                                   terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
                                                   write_file_header, 1);
        std::cout << std::endl;
        ...
        SU_Oracle_Adapt_notA2A_or_A2A_with_output(poi_num, &point_cloud, poi_list, source_poi_index, destination_poi_index, point_cloud_exact_distance,
                                                  terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
                                                  terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
                                                  write_file_header, 1);
        std::cout << std::endl;

        std::cout << "== SU_Oracle_Adapt_A2A ==" << std::endl;
        SU_Oracle_Adapt_notA2A_or_A2A_with_output(poi_num, &point_cloud, poi_list, source_poi_index, destination_poi_index, point_cloud_exact_distance,
                                                  terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
                                                  terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
                                                  write_file_header, 2);
        ...
        RC_Oracle_Naive_or_RC_Oracle_Naive_Adapt_notA2A_AR2AR_or_A2A_AR2AR_with_output(
            poi_num, &point_cloud, poi_list, source_poi_index, destination_poi_index, point_cloud_exact_distance,
            terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
            terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
            write_file_header, 1, 1);
        std::cout << std::endl;
        ...
        std::cout << "== RC_Oracle_Naive_Adapt_AR2AR ==" << std::endl;
        RC_Oracle_Naive_or_RC_Oracle_Naive_Adapt_notA2A_AR2AR_or_A2A_AR2AR_with_output(
            poi_num, &point_cloud, poi_list, source_poi_index, destination_poi_index, point_cloud_exact_distance,
            terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
            terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
    ...
    std::cout << "== RC_Oracle_A2P_SmCon_NaiveProx ==" << std::endl;
    RC_Oracle_A2P_SmCon_or_RC_Oracle_Adapt_AR2P_SmCon_notNaiveProx_or_NaiveProx_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
        write_file_header, 2, 1);
    ...
    std::cout << "== RC_Oracle_A2P_SmQue_NaiveProx ==" << std::endl;
    RC_Oracle_A2P_SmQue_or_A2A_or_RC_Oracle_Adapt_AR2P_SmQue_or_AR2AR_notNaiveProx_or_NaiveProx_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
        write_file_header, 1, 2, 1);
    std::cout << std::endl;

    std::cout << "== RC_Oracle_A2A_NaiveProx ==" << std::endl;
    RC_Oracle_A2P_SmQue_or_A2A_or_RC_Oracle_Adapt_AR2P_SmQue_or_AR2AR_notNaiveProx_or_NaiveProx_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
        write_file_header, 2, 2, 1);
    std::cout << std::endl;

    std::cout << "== RC_Oracle ==" << std::endl;
    RC_Oracle_or_RC_Oracle_Adapt_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
        write_file_header, 1);
    ...
    std::cout << "== RC_Oracle_A2P_SmCon ==" << std::endl;
    RC_Oracle_A2P_SmCon_or_RC_Oracle_Adapt_AR2P_SmCon_notNaiveProx_or_NaiveProx_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
    ...
    std::cout << "== RC_Oracle_A2P_SmQue ==" << std::endl;
    RC_Oracle_A2P_SmQue_or_A2A_or_RC_Oracle_Adapt_AR2P_SmQue_or_AR2AR_notNaiveProx_or_NaiveProx_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
        write_file_header, 1, 1, 1);
    std::cout << std::endl;
    ...
    std::cout << "== RC_Oracle_Adapt_AR2P_SmCon ==" << std::endl;
    RC_Oracle_A2P_SmCon_or_RC_Oracle_Adapt_AR2P_SmCon_notNaiveProx_or_NaiveProx_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
    ...
    std::cout << "== RC_Oracle_Adapt_AR2P_SmQue ==" << std::endl;
    RC_Oracle_A2P_SmQue_or_A2A_or_RC_Oracle_Adapt_AR2P_SmQue_or_AR2AR_notNaiveProx_or_NaiveProx_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
        write_file_header, 1, 1, 2);
    std::cout << std::endl;

    std::cout << "== RC_Oracle_Adapt_AR2AR ==" << std::endl;
    RC_Oracle_A2P_SmQue_or_A2A_or_RC_Oracle_Adapt_AR2P_SmQue_or_AR2AR_notNaiveProx_or_NaiveProx_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
        write_file_header, 2, 1, 2);
    std::cout << std::endl;

    std::cout << "== TI_Oracle_NaiveProx ==" << std::endl;
    TI_Oracle_notA2A_or_A2A_NaiveProx_or_Rtree_or_TigLoo_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
        write_file_header, 1, 1);
    ...
    std::cout << "== TI_Oracle_Rtree ==" << std::endl;
    TI_Oracle_notA2A_or_A2A_NaiveProx_or_Rtree_or_TigLoo_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
    ...
    std::cout << "== TI_Oracle_TigLoo ==" << std::endl;
    TI_Oracle_notA2A_or_A2A_NaiveProx_or_Rtree_or_TigLoo_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
    ...
    std::cout << "== TI_Oracle_A2A_NaiveProx ==" << std::endl;
    TI_Oracle_notA2A_or_A2A_NaiveProx_or_Rtree_or_TigLoo_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
    ...
    std::cout << "== TI_Oracle_A2A_Rtree ==" << std::endl;
    TI_Oracle_notA2A_or_A2A_NaiveProx_or_Rtree_or_TigLoo_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
    ...
    std::cout << "== TI_Oracle_A2A_TigLoo ==" << std::endl;
    TI_Oracle_notA2A_or_A2A_NaiveProx_or_Rtree_or_TigLoo_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
        write_file_header, 2, 3);
    std::cout << std::endl;

    std::cout << "== TI_Oracle ==" << std::endl;
    TI_Oracle_notA2A_or_A2A_TI_Oracle_Adapt_notAR2AR_or_AR2AR_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
        write_file_header, 1, 1);
    ...
    std::cout << "== TI_Oracle_A2A ==" << std::endl;
    TI_Oracle_notA2A_or_A2A_TI_Oracle_Adapt_notAR2AR_or_AR2AR_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
    ...
    std::cout << "== TI_Oracle_Adapt ==" << std::endl;
    TI_Oracle_notA2A_or_A2A_TI_Oracle_Adapt_notAR2AR_or_AR2AR_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
    ...
    std::cout << "== TI_Oracle_Adapt_AR2AR ==" << std::endl;
    TI_Oracle_notA2A_or_A2A_TI_Oracle_Adapt_notAR2AR_or_AR2AR_with_output(
        poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
        terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
        terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
    ...
    SE_Oracle_FastFly_Adapt_notA2A_or_A2A_with_output(poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
                                                      terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
                                                      terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
                                                      write_file_header, 1);
    std::cout << std::endl;
    ...
    std::cout << "== UP_Oracle_FastFly_Adapt ==" << std::endl;
    UP_Oracle_FastFly_Adapt_notA2A_or_A2A_with_output(poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
                                                      terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
                                                      terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
                                                      write_file_header, 1);
    std::cout << std::endl;

    std::cout << "== UP_Oracle_FastFly_Adapt_A2A ==" << std::endl;
    UP_Oracle_FastFly_Adapt_notA2A_or_A2A_with_output(poi_num, &point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
                                                      terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
                                                      terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
                                                      write_file_header, 2);
    ...
    std::cout << "== DIO_Adapt ==" << std::endl;
    DIO_Adapt_or_DIO_with_output(&point_cloud, poi_list, source_poi_index, destination_poi_index, point_cloud_exact_distance,
                                 terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
                                 terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
                                 write_file_header, 1);
    std::cout << std::endl;

    std::cout << "== ESP_Adapt ==" << std::endl;
    ESP_Adapt_or_ESP_with_output(&point_cloud, poi_list, epsilon, source_poi_index, destination_poi_index, point_cloud_exact_distance,
                                 terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
                                 terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
                                 write_file_header, 1);
    std::cout << std::endl;

    std::cout << "== DIJ_Adapt ==" << std::endl;
    DIJ_Adapt_or_DIJ_with_output(&point_cloud, poi_list, source_poi_index, destination_poi_index, point_cloud_exact_distance,
                                 terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
                                 terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
                                 write_file_header, 1);
    std::cout << std::endl;
    ...
    FastFly_or_FastFly_Adapt_with_output(&point_cloud, poi_list, source_poi_index, destination_poi_index, point_cloud_exact_distance,
                                         terrain_exact_distance, run_knn_query, run_range_query, k_value, range, point_cloud_exact_all_poi_knn_query_list,
                                         terrain_exact_all_poi_knn_query_list, point_cloud_exact_all_poi_range_query_list, terrain_exact_all_poi_range_query_list,
                                         write_file_header, 1);
    std::cout << std::endl;
